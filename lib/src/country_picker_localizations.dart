...
class CountryPickerLocalizations {
  ...
  static LocalizationsDelegate<CountryPickerLocalizations> getDelegate({bool enableLocalization = true}) {
    return _CountryPickerLocalizationsDelegate(enableLocalization: enableLocalization);
  }
  ...
  Future<bool> load() async {
    String jsonString =
        await rootBundle.loadString('packages/country_phone_picker/src/i18n/${locale.languageCode}.json');
...
class _CountryPickerLocalizationsDelegate extends LocalizationsDelegate<CountryPickerLocalizations> {
  ...
  Future<CountryPickerLocalizations> load(Locale locale) async {
    ...
    CountryPickerLocalizations localizations = CountryPickerLocalizations(effectiveLocale);
